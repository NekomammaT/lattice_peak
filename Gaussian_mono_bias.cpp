...
const std::string mapfileprefix = "data/mono_bias_map_256_";
// const std::string biasedfileprefix = "data/mono_biased_";
const std::string laplacianfileprefix = "data/mono_bias_laplacian_256_";
// const std::string powerfileprefix = "data/mono_power_";
const std::string peakfileprefix = "data/mono_bias_peak_256_";
...
int main(int argc, char *argv[])
{
  ...
  // ----------- unbiased map -----------
  std::vector<std::vector<std::vector<std::complex<double>>>> gk = dwk(nsigma, bias, seed);
